...
pub(crate) struct InlineFormattingContext {
    ...
    pub font_metrics: Vec<FontIdentifierAndMetrics>,
...
#[derive(Debug, Serialize)]
pub(crate) struct FontIdentifierAndMetrics {
    pub identifier: Atom,
...
pub(super) struct InlineFormattingContextState<'a, 'b> {
    ...
    /// we are laying out.
    fonts: &'a Vec<FontIdentifierAndMetrics>,
...
impl InlineFormattingContext {
    ...
    pub(super) fn layout(
        ...
        // that situation the style of the cotnaining block is unknown.
    ...
    pub(crate) fn break_and_shape_text(&mut self, layout_context: &LayoutContext) {
        ...
        let _ = std::mem::replace(&mut self.font_metrics, ifc_fonts);
    }
}
